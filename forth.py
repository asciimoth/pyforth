...
text = """
# Word with addres 0 that do nothing
: [[     [ [ ;
: [[[    [ [ [ ;
: [[[[   [ [ [ [ ;
: [[[[[  [ [ [ [ [ ;
...
dictionary = [
    # . - print from stack
    # ^ - delete from stack
    # ^^ - double delete from stack
    # -> move from stackA to stackB
    # <-  move from stackB to stackA
    # >. move pointer
    # __tick - setup tickrate
    # __stop - stop program
    # __print_dict - print dictionary
    # random
]
